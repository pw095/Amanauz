...
SELECT
  ...
  FROM (SELECT
               ...
               security_type_id,
               security_type_name
          FROM tech$default_data_security_type src
         WHERE NOT EXISTS(SELECT
                                 NULL
                            FROM default_data_security_type sat
                           WHERE
        ...
        SELECT
          ...
          FROM (SELECT
                  ...
                  FROM (SELECT
                          ...
                          FROM tech$default_data_security_type src
                               JOIN
                               default_data_security_type sat
                                   ON
                                      sat.security_type_id = src.security_type_id
 ...
 DO UPDATE
       SET tech$expiration_dt = excluded.tech$expiration_dt,
           ...
           security_type_name = CASE WHEN tech$expiration_dt = '2999-12-31' AND excluded.tech$expiration_dt = '2999-12-31' THEN excluded.security_type_name ELSE security_type_name END
