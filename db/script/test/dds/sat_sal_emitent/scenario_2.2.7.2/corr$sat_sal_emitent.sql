...
SELECT
  ...
  FROM (SELECT
               tech$effective_dt,
               tech$expiration_dt,
               'scenario_2.2.7.2' AS full_name,
               'scenario_2.2.7.2' AS short_name,
               NULL               AS reg_date,
               NULL               AS ogrn,
               inn,
               okpo
          FROM (SELECT
                       ...
                       '2021-09-30' AS tech$expiration_dt,
                       NULL         AS inn,
                       NULL         AS okpo
                 UNION ALL
                SELECT
                       '2021-10-01' AS tech$effective_dt,
                       '2021-11-30' AS tech$expiration_dt,
                       '0010033331' AS inn,
                       NULL         AS okpo
                 UNION ALL
                SELECT
                       '2021-12-01' AS tech$effective_dt,
