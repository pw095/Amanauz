...
CREATE TABLE tbl_entity_load_queue
  (
    ...
    elq_flow_log_id                INTEGER             NOT NULL,
    elq_elm_id                     INTEGER             NOT NULL,
    elq_parent_elm_id              INTEGER             NOT NULL,
    elq_child_elm_id               INTEGER             NOT NULL,
    ...
    UNIQUE(elq_flow_log_id, elq_elm_id),
    UNIQUE(elq_elm_id, elq_iteration_number),
    FOREIGN KEY (elq_flow_log_id) REFERENCES tbl_flow_log(flow_id)        ON DELETE CASCADE,
