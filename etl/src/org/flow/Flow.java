...
//        Данные за несколько дней, листов много
        ...
        entityList.add(new DetailDataEntity(flow, "sat_security_rate"));
        entityList.add(new DetailDataEntity(flow, "sat_security_rate_bond"));
        entityList.add(new DetailDataEntity(flow, "sat_security_type"));
